document.addEventListener("DOMContentLoaded",
    function(e){
        let confidID = document.querySelector("#id i");
        let idText = document.querySelector("#id span");

        confidID.addEventListener("click",
            function(e){
        ...
        profileEditButton.addEventListener("click",
            function(e){
                if(changing){
                    let _userInfo = userInfo.querySelector("input")
                    let _summary = summary.querySelector("input")
                    ...
                    _profileDetail.innerHTML = _profileDetail
